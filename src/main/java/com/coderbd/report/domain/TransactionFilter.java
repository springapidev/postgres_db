package com.coderbd.report.domain;

import com.coderbd.entity.Company;
import com.coderbd.report.domain.report.ExportType;
import com.coderbd.report.domain.report.dynamic.DynamicReportProperties;
...
public class TransactionFilter {
  ...
  public DynamicReportProperties generateDynamicColumnAndRowsForCompany(List<Company> list) {
    var totalVolume = Double.valueOf(0.00);
    var totalAmount = Double.valueOf(0.00);
    DecimalFormat df = new DecimalFormat("#,###.###");
